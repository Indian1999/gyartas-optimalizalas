...
xgyk = pulp.LpVariable("gyk", lowBound = 0, cat = "Integer")
xrk = pulp.LpVariable("rk", lowBound = 0, cat = "Integer")
xk4 = pulp.LpVariable("k4", lowBound = 0, cat = "Integer")
xk5 = pulp.LpVariable("k5", lowBound = 0, cat = "Integer")
